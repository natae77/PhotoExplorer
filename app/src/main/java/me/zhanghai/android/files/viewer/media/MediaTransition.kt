...
/**
 * ⚠️ Plan 18 section 5.1: a transition that never starts, one that starts with no shared element,
...
/**
 * The shared element name of the media tile for [path], see plan 18 section 3.2.3.
 *
...
/**
 * What the page on screen is able to hand to the return transition, see plan 18 section 3.5.
 *
